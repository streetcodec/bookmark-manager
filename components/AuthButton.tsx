...
export default function AuthButton({ session }: { session: any }) {
    ...
    return (
        <button
            ...
            className="group relative rounded-2xl p-[1px] transition-all duration-500 hover:scale-[1.03] active:scale-[0.98]"
        >
            <div className="absolute inset-0 bg-gradient-to-br from-primary via-secondary to-accent rounded-2xl opacity-70 group-hover:opacity-100 blur-[2px] group-hover:blur-md transition-all duration-500" />
            <div className="relative px-8 py-3.5 bg-background rounded-[15px] flex items-center gap-4">
                ...
                <span className="text-white font-display font-bold tracking-tight">Access Library</span>
            </div>
        </button>
    )
}
